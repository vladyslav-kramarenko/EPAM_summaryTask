...
//		DataSource ds = (DataSource) envContext.lookup("jdbc://localhost:1527/st4db;create=true");
			con = ds.getConnection();
			/////////////////////////////////
//			String dbUrl = "jdbc:derby://localhost:1527/st4db;create=true";
//			con = DriverManager.getConnection(dbUrl);
	...
	public static void main(String[] args) throws SQLException {
		...
		System.out.println(manager.getMaxId(con,"SELECT * FROM Categories"));
	}
